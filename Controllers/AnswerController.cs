...
namespace ExamEase.Controllers
{
    ...
    public class AnswerController : Controller
    {
        ...
        public AnswerViewModel GetViewModel(string Id, string type)
        {
            ...
            model.QuestionId = Id;
            var questionDetail = db.Questions.Where(a => a.Id == Id).Select(a => new { Title = a.QuestionTitle, TypeId = a.QuestionTypeId ,video=a.VideoAyet}).FirstOrDefault();
            model.QuestionTitle = questionDetail.Title;
            model.VideoAyet = questionDetail.video;
